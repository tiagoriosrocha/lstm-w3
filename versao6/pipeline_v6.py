...
# Nesta versao, trabalhamos com o problema de classificacao por serie.
...
ARTIFACTS_ROOT = PROJECT_ROOT / "artifacts" / "reports_v6"
SERIES_STAT_NAMES = [
    "mean",
    "std",
    "min",
...
def require_classification_stack() -> None:
    ...
    if (
        ...
        raise ImportError(
            ...
            "Instale scikit-learn para executar a versao6."
        )
...
def prepare_classification_artifacts(
    *,
    ...
    bundle_path = run_dir / "bundle_v6.json"
    ...
    class LSTMSeriesClassifier(nn.Module):
        def __init__(
            ...
            self.classifier = nn.Sequential(
                nn.Linear(hidden_size * self.output_multiplier, 128),
                nn.GELU(),
                nn.Dropout(dropout),
        ...
        def forward(self, x: torch.Tensor) -> torch.Tensor:
            ...
            _, (hidden_state, _) = self.lstm(normalized)
...
def train_lstm_classifier(
    ...
    *,
    ...
    checkpoint_path = output_dir / "lstm_multiclasse_best.pt"
    config_path = output_dir / "lstm_multiclasse_config.json"
    history_path = output_dir / "lstm_multiclasse_history.csv"
